...
;( function( window ) {
	...
	FForm.prototype._init = function() {
		...
		// show first field
		$(this.fields).eq(this.current).addClass('fs-current');
	...
	FForm.prototype._addControls = function() {
		...
		this.holder = createElement( 'div', { cName : 'fs-continue-container', appendTo : this.ctrls } );
		this.holderCenter = createElement( 'div', { cName : 'fs-continue-container-center', appendTo : this.holder } );

		this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : 'Continue', appendTo : this.holderCenter } );
	...
	FForm.prototype._nextField = function( backto ) {
		...
		$(currentFld).removeClass('fs-current');
		$(currentFld).addClass('fs-hide');
		...
		var self = this,
			onEndAnimationFn = function( ev ) {
				...
				if( self.isLastStep ) {
					...
					$(self.formEl).addClass('fs-form-overview');
					$(self.formEl).addClass('fs-show');
	...
	FForm.prototype._updateNav = function() {
		if( this.options.ctrlNavDots ) {
			$(this.ctrlNav.querySelector( 'button.fs-dot-current' )).removeClass('fs-dot-current');
